 ...
 * Fields
 */
$arrLang['lockExplanation'] = 'Die hier getätigten Einstellungen können evtl. an einem Frontendmodul überschrieben werden.';
$arrLang['addLockIntervals'] = array('Sperrzeiträume festlegen', 'Wählen Sie diese Option, wenn gesperrte Inhalte nach einer bestimmten Zeit wieder freigegeben werden sollen.');
